#!/usr/bin/env python3
"""
phantombuster-alternative - PhantomBuster to CoreClaw Migration Demo

This script demonstrates how to migrate from PhantomBuster to CoreClaw's Web Data API.
...
class PhantombusterAlternative:
    """Demo: Migrate from PhantomBuster to CoreClaw Web Data API."""
...
def main():
    parser = argparse.ArgumentParser(description="phantombuster-alternative - PhantomBuster to CoreClaw Migration")
    ...
    client = PhantombusterAlternative(api_key=args.api_key)
